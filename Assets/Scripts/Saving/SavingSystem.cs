...
namespace TkrainDesigns.Saving
{
    ...
    public class SavingSystem :MonoBehaviour
    {
        ...
        static Dictionary<string, object> LoadFile(string saveFile)
        {
        ...
        static void SaveFile(string saveFile, object state)
        {
            string path = GetPathFromSaveFile(saveFile);
        ...
        static string GetPathFromSaveFile(string saveFile)
        {
